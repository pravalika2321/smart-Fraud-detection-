...
type View = 'home' | 'analyze' | 'results' | 'about' | 'how-it-works' | 'contact' | 'login' | 'activity-history' | 'admin' | 'resume-analyzer' | 'interview-prep' | 'interview-practice';
...
const App: React.FC = () => {
  ...
  const navigateTo = (view: View) => {
    if ((['analyze', 'activity-history', 'resume-analyzer', 'interview-prep', 'interview-practice'] as View[]).includes(view) && !currentUser) {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'interview-practice': return <InterviewPractice />;
